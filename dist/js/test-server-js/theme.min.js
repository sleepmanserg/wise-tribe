...
export function menuToggle() {
  /** Menu toggle */
    ...
    if (menuToggle) {
      ...
      var menuLinks = document.querySelectorAll('.header-inner [data-ajax-link]');
...
export function preloaderFunction() {
  /** Preloader */
