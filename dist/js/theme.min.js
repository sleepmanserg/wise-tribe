...
var applyParallax = function applyParallax(section) {
  section.addEventListener('mousemove', function (e) {
    var _section$getBoundingC = section.getBoundingClientRect(),
        width = _section$getBoundingC.width,
        height = _section$getBoundingC.height;

    var offX = e.pageX - width * 0.5;
    var offY = e.pageY - height * 0.5;

    var _iterator3 = _createForOfIteratorHelper(document.querySelectorAll('.parallax')),
        _step3;
    ...
    try {
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
        ...
        var _x = offX * speed / 100;

        var _y = offY * speed / 2000;

        layer.style.transform = "translateX(".concat(_x, "px) translateY(").concat(_y, "px)");
      }
    } catch (err) {
      _iterator3.e(err);
    } finally {
  ...
  section.addEventListener('mouseleave', function (e) {
    var _iterator4 = _createForOfIteratorHelper(document.querySelectorAll('.parallax')),
        _step4;
...
applyParallax(document.querySelector('.circle-section')); // let applyParallax = section => {
