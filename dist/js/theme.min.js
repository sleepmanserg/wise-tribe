...
breakpointChecker(); // var blogSwiper = new Swiper(".latest-slider", {
// 	slidesPerView: 1,
// 	spaceBetween: 10,
// 	loop: true,
// });
...
if (loadmore) {
  loadmore.addEventListener('click', function (e) {
    ...
    var elementList = _toConsumableArray(document.querySelectorAll('.events-grid .events-card'));

    for (var _i = currentItems; _i < currentItems + 3; _i++) {
      if (elementList[_i]) {
        elementList[_i].style.display = 'block';
      }
    }
...
var rellax = new Rellax('.rellax'); // Some random colors

var colors = ["#ff69f9", "#6c69ff", "#69d5ff"];
var numBalls = 15;
var balls = [];

for (var _i2 = 0; _i2 < numBalls; _i2++) {
  var ball = document.createElement("div");
  ball.classList.add("decor-circle");
  var random_color = colors[Math.floor(Math.random() * colors.length)];
  ball.style.boxShadow = '0px 0px 5px 3px ' + random_color;
  ball.style.left = "".concat(Math.floor(Math.random() * 100), "vw");
  ball.style.top = "".concat(Math.floor(Math.random()));
...
var randomCircles = function randomCircles() {
  var decorCircles = document.querySelectorAll('.decor-circle'); // let experienceSection = document.querySelector('.experience');

  var documentWidth = window.innerWidth;
  var documentHeight = window.innerHeight;

  for (var _i3 = 0; _i3 < decorCircles.length; _i3++) {
    var thisDecorCircles = decorCircles[_i3];
    var randomTop = getRandomNumber(0, documentHeight);
    var randomLeft = getRandomNumber(0, documentWidth);
