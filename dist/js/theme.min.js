...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function loadPlaylist(target, myPlaylist, id, listclass) {
    ...
    if (myPlaylist) {
      PlyrPlaylist(".plyr-playlist", myPlaylist, limit, id, listclass); //return
    }
    ...
    function PlyrPlaylist(target, myPlaylist, limit, id, listclass) {
      ...
      $.each(myPlaylist, function (id, val) {
        ...
        items.push('<li class="' + playingclass + '"><a href="#" data-plyr-provider="' + val.sources[0].type + '" data-plyr-embed-id="' + val.sources[0].src + '"><img class="plyr-miniposter" src="' + val.poster + '"> ' + val.title + " - " + val.author + "</a></li> ");
        if (id == limit) return false;
      });
      $(target).html(items.join(""));
      players[0].on("ended", function (event) {
        var $next = $(".plyr-playlist .pls-playing").next().find("a").trigger("click");
      });
    }
