...
function blogSectionPaddingHack() {
  var sectionWidth = document.querySelector('.blog-slider').offsetWidth;
  var containerWidth = document.querySelector('.container').offsetWidth;
  var blogOffset = (sectionWidth - containerWidth) / 2;
  var blogContent = document.querySelector('.blog-slider__content');
...
function checkForWindowResize() {
  console.log("Screen width: ".concat(window.innerWidth));
  blogSectionPaddingHack();
}
