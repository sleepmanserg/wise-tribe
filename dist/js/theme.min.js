...
var parallaxWrapper = document.querySelector('.parallax-wrap');

if (parallaxWrapper) {
  var parallax = function parallax(e) {
    this.querySelectorAll('.parallax').forEach(function (layer) {
      var speed = layer.getAttribute('data-speed');
      var x = (window.innerWidth - e.pageX * speed) / 100;
      var y = (window.innerHeight - e.pageY * speed) / 100;
      layer.style.transform = "translate(".concat(x, "px) translate(").concat(y, "px)");
    });
  };
    ...
    var loadPlaylist = function loadPlaylist(target, allVideos, id, listclass) {
      ...
      function PlyrPlaylist(target, allVideos, limit, id, listclass) {
        ...
        players[0].on('exitfullscreen', function () {
          ...
          $('body').removeClass('video-fullscreen'); // $('#video-main .plyr').css('pointer-events', 'none');
        });
        players[0].on('enterfullscreen', function () {
          $('#video-main .plyr').addClass('video-fullscreen');
          $('#video-main .plyr .plyr__controls').css('display', 'flex');
          $('body').addClass('video-fullscreen'); // players[0].play();
        });
      }
      ...
      function videoControlsMediaText() {
        ...
        $('.video-player-playlist__actions .song-name').html("".concat(playingVideoText));
        $('.video-player-playlist__actions .song-media').html("".concat(playingVideoArtist));
      }
      ...
      players[0].on("ready", function (event) {
        ...
        $('.video-player-playlist__actions .player-controls__bottom-thumb').html("<img src=\"".concat(players[0].poster, "\"></img>"));
