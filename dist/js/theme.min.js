...
var breakpointChecker = function breakpointChecker() {
  ...
  if (breakpoint.matches === true) {
    ...
    if (blogSidebarSlider && blogSidebarSlider !== undefined) blogSidebarSlider.destroy(true, true); // or/and do nothing
...
trackMain.addEventListener('ended', function () {
  ...
  playingNow(); // switch (shuffleBtn.className) {
  // 	case 'bottom-controls-btn':
  // 		nextMusic();
  // 		playingNow();
  // 		break;
...
for (var _i = 0; _i < allMusic.length; _i++) {
  _loop(_i);
...
playerVolumeBtn.addEventListener('click', function () {
  toggleMute();
  playerVolumeBtn.classList.toggle('muted'); // playerVolumeBtn.nextElementSibling(playerVolumeSliderContainer)
