...
var controls = ['play' // Play/pause playback
];
var players = Plyr.setup('.hero-player', {
  controls: controls
});
swiperMainHome.on('slideChange', function () {
  ...
  var index_currentSlide = swiperMainHome.activeIndex;
  var currentSlide = swiperMainHome.slides[index_currentSlide];
  setTimeout(function () {
